// Node.js script to seed the aptitude quiz
...
async function createOrUpdateAptitudeQuiz() {
  try {
...
// Authenticate and run the seeding function
async function seedAptitudeQuiz() {
  try {
    ...
    const password = "admin123"; // Replace with actual admin password
