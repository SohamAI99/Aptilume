        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-4 text-center">
              <h3 className="text-xl font-semibold">{profileData.name || 'Student'}</h3>
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-2">Company Interests</label>
                <input
                  type="text"
                  value={profileData.interests}
                  onChange={(e) => handleChange('interests', e.target.value)}
                  className="w-full px-4 py-2 bg-background border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition"
                  placeholder="Enter companies you're interested in (e.g. Google, Microsoft, Amazon)"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-background border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition"
                  placeholder="List your skills (e.g. JavaScript, Python, Data Structures, Algorithms)"
                  rows={3}
                />
              </div>
            </div>
