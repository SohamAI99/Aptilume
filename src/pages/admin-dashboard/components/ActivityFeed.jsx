      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {filteredActivities?.length > 0 ? (
          filteredActivities?.map((activity) => {
            ...
            const StatusIconComponent = activity?.status ? getStatusIcon(activity?.status) : null;
                  ...
                  {activity?.status && (
                    <div className="flex items-center mt-2">
                      <span className={cn(
                        ...
                        {StatusIconComponent && <StatusIconComponent className="h-2.5 w-2.5 mr-1" />}
          ...
          <div className="text-center py-8">
            ...
            <h4 className="text-sm font-medium text-foreground mb-1">No activities found</h4>
            <p className="text-xs text-muted-foreground">There are no activities matching your current filters.</p>
          </div>
        )}
      </div>
    </div>
