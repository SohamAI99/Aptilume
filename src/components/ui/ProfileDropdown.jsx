        ...
        <div className="absolute right-0 mt-2 w-56 bg-background border border-border rounded-lg shadow-lg z-50">
          <div className="p-4 border-b border-border">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-medium text-foreground">{currentUser?.name || 'User'}</p>
          ...
          <div className="p-2">
            <button
              ...
              className="w-full text-left px-3 py-2 text-sm text-foreground hover:bg-muted rounded transition-colors flex items-center gap-2"
            >
