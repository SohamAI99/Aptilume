// Script to add sample questions to a quiz
...
export const addSampleQuestionsToQuiz = async (quizId) => {
  try {
...
export const getFirstQuizId = async () => {
  try {
...
export const runAddQuestionsScript = async () => {
  try {
...
export default { addSampleQuestionsToQuiz, getFirstQuizId, runAddQuestionsScript };