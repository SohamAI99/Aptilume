// Client-side quiz seeder for development
...
export async function deleteExistingQuizzes() {
  try {
...
export async function seedQuizzes() {
  try {
    ...
    for (let i = 0; i < sampleQuizzes.length; i++) {
      ...
      // Generate additional questions to reach the specified count
...
export default { seedAllQuizzes, seedQuizzes, deleteExistingQuizzes };